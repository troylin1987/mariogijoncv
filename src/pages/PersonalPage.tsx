    ...
    <section className="space-y-6">
      <div className="panel p-8 lg:p-10">
        <div className="grid gap-7 lg:grid-cols-[1.2fr_1fr]">
          ...
          <img src="/media/personal/mario-photo3.jpg" alt="Mario Gijon" className="h-[320px] w-full self-end rounded-2xl border border-orange-500/30 bg-white object-[50%_82%] object-cover shadow-lg md:h-[235px]" />
        </div>
        ...
        <div className="mt-6 grid gap-3 md:grid-cols-3">
          {capabilityBlocks.map((item, index) => (
            <div key={item.label} className={`panel-soft p-4 fade-up stagger-${index + 1} border-orange-400/30`}>
              <img src={`/media/capabilities/${item.iconName}.svg`} alt={item.label} className="h-10 w-10" />
      ...
      <div className="panel p-7">
        <div className="flex items-center gap-3">
          <img src="/media/kinds/portfolio.svg" alt="Portfolio" className="h-10 w-10" />
