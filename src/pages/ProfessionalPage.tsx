    ...
    <section className="space-y-6">
      <div className="panel p-8 lg:p-10">
        <div className="grid gap-7 lg:grid-cols-[1.25fr_1fr]">
          ...
          <img src="/media/personal/mario-photo2.jpg" alt="Mario Gijon" className="h-[235px] w-full self-end rounded-2xl border border-orange-500/30 bg-white p-2 object-contain shadow-lg" />
        </div>
