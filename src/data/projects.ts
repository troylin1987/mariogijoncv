...
function mergeProjectDetails(defaultDetails: ProjectDetails, override?: Partial<ProjectDetails>): ProjectDetails {
  ...
  return {
    description: override.description ?? defaultDetails.description,
    problem: override.problem ?? defaultDetails.problem,
    solution: override.solution ?? defaultDetails.solution,
    results: override.results ?? defaultDetails.results,
...
function getProjectTranslation(project: Project, locale: string): ProjectTranslationResult | undefined {
  ...
  if (!staticTranslation && !inlineTranslation) {
    return undefined;
  }

  return {
    title: staticTranslation?.title ?? inlineTranslation?.title,
    summary: staticTranslation?.summary ?? inlineTranslation?.summary,
    role: staticTranslation?.role ?? inlineTranslation?.role,
    context: staticTranslation?.context ?? inlineTranslation?.context,
    details: mergeProjectDetails(project.details, {
      ...inlineTranslation?.details,
      ...staticTranslation?.details
    })
  };
}
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    "category": "Personal",
    "kind": "Web",
    "summary": "Herramienta para organizar y compartir pronósticos deportivos de quiniela.",
    "role": "Arquitecto de Soluciones",
    "image": "/media/projects/quinielator.png",
    "technologies": [
      "JavaScript",
      "HTML",
      "CSS",
    ...
    "liveUrl": "https://quinielator.gt.tc/",
    "route": "/project/quinielator",
    "context": "Experimento personal para gestionar apuestas y resultados deportivos.",
    "details": {
      "description": "Quinielator es una utilidad web para crear y estructurar pronósticos deportivos de quiniela y compartirlos con amigos.",
      "problem": "No había una herramienta simple para organizar pronósticos deportivos de forma clara y accesible.",
      "solution": "Construimos una utilidad ligera para gestionar pronósticos y añadimos soporte con Gemini AI para sugerencias y análisis de combinaciones.",
      "results": "Facilidad para planificar la quiniela y un diseño directo enfocado en la información clave.",
      "features": [
        "Gestión de pronósticos",
        "Compartir resultados",
        "Sugerencias con Gemini AI",
    ...
    "translations": {
      "ENG": {
        "summary": "Tool to organize and share sports betting predictions for quinielas.",
        "role": "Solutions Architect",
        "context": "Personal experiment for managing sports betting forecasts.",
        "details": {
          "description": "Quinielator is a web utility for creating and organizing quiniela sports predictions and sharing them with friends.",
          "problem": "There was no simple tool to organize sports predictions clearly and accessibly.",
          "solution": "We built a lightweight interface to record results, share selections, and review match picks.",
          "results": "Easier quiniela planning with a straightforward design focused on key information.",
          "features": [
  ...
  },
  {
    ...
    "category": "Personal",
    "kind": "Web",
    "summary": "Repositorio de cartas y recursos para coleccionistas y fans de Pokémon TCG.",
    "role": "Arquitecto de Soluciones",
    "image": "/media/projects/pokemon.webp",
    "technologies": [
      "React",
      "Vite",
      "Github Actions",
    ...
    "liveUrl": "https://pokemontcg.gt.tc/",
    "route": "/project/pokemon-tcg",
    "context": "Proyecto personal para aficionados a las cartas coleccionables de Pokémon.",
    "details": {
      "description": "PokemonTCG es un sitio informativo para coleccionistas de cartas Pokémon, con datos sobre barajas y cartas clave.",
      "problem": "Los jugadores necesitaban un recurso rápido para consultar cartas y construir barajas.",
      "solution": "Rediseñamos la plataforma con React + Vite, backend en Supabase, despliegue en Render y CI/CD con GitHub Actions.",
      "results": "Una herramienta accesible para fans del TCG que combina información y navegación ágil.",
      "features": [
        "Catálogo de cartas",
        "Búsqueda avanzada",
    ...
    "translations": {
      "ENG": {
        "summary": "Card repository and resource site for Pokémon TCG collectors and fans.",
        "role": "Solutions Architect",
        "context": "Personal project for collectible Pokémon card enthusiasts.",
        "details": {
          "description": "PokemonTCG is an informational site for Pokémon card collectors, with data on decks and key cards.",
          "problem": "Players needed a quick resource to look up cards and build deck ideas.",
          "solution": "We created a lightweight site with filters and visual content that helps understand card collections.",
          "results": "An accessible tool for TCG fans that combines information with fast navigation.",
          "features": [
            "Card catalog",
            "Deck references",
            "Visual content",
